...
ax1.plot(precisionInOrder, costNashInOrder, color='b', label='Gurobi Nash Objective')
ax1.set_xscale('log')
ax1.hlines(yNashAquilibraeR, np.min(precision), np.max(precision), color='b', linestyle='dashed', label='AquilibreE Nash Objective')
ax2 = ax1.twinx()
ax2.plot(precisionInOrder, socialCostInOrder, color='r', label='Gurobi Social Cost')
ax2.hlines(ySocialAquilibraeR, np.min(precision), np.max(precision), color='r', linestyle='dashed', label='AquilibreE Social Cost')
