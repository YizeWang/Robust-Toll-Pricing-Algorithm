...
with open(pathLogFile, 'wt') as logFile:
    ...
    # xToll1, costToll1, _, _, _, _ = ComputeFlow(G, sampleODs, tOpt1)
    ...
    # xToll2, costToll2, _, _, _, _ = ComputeFlow(G, sampleODs, tOpt2)
    # print("costToll2: %f" % costToll2)
    # print("tOpt2: ", tOpt2)

    tOpt = ComputeOptimalTolls(G, sampleODs, pathSolFile)
    xToll, costToll, _, _, _, _ = ComputeFlow(G, sampleODs, tOpt)
    print("costToll2: %f" % costToll)
    print("tOpt2: ", tOpt)
