...
plt.figure()
# plt.hist(PoAMCT, bins=5, alpha=0.5, label="MCT")
plt.hist(PoAToll1, bins=500, alpha=1, label="Toll1", color='m')
plt.hist(PoAToll2, bins=500, alpha=1, label="Toll2", color='orange')
plt.hist(PoAUserEq, bins=500, alpha=1, label="Toll-Free", color='tab:blue')
